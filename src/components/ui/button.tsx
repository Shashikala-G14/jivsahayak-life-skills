  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        ...
        hero:
          "hero-gradient text-white shadow-elevated hover:shadow-glow hover:-translate-y-0.5",
        nature:
          "nature-gradient text-white shadow-soft hover:shadow-elevated hover:-translate-y-0.5",
        accent:
          "bg-accent text-accent-foreground shadow-soft hover:shadow-elevated hover:bg-accent/90",
        glass:
          "glass-card text-foreground hover:bg-card/90",
        icon:
          "bg-muted text-foreground hover:bg-primary hover:text-primary-foreground rounded-2xl p-0",
      },
      size: {
        ...
        icon: "h-12 w-12",
        iconLg: "h-14 w-14 md:h-16 md:w-16",
      },
    },
    defaultVariants: {
      variant: "default",
